...
if maslo>=20:
    maslo= " "+ str(maslo) + " Тонн"
else:
    maslo= "Требуется дозапрвка осталось: "+ str(maslo) + " Тонн"

if toplbak>=900:
    toplbak= " "+ str(toplbak) + " Тонн"
else:
    toplbak= "требуется дозаправка осталось: "+ str(toplbak) +  " Тонн"
G=1/14000*110*g*W
...
xl = pd.DataFrame({"Тип расходника": ["Кол-во топлива", "Кол-во масла"],
                            "  ":[toplbak, maslo]
                            })
